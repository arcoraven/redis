...
[![GoDoc](https://godoc.org/github.com/arcoraven/redis?status.svg)](https://godoc.org/github.com/arcoraven/redis)

Supports:

- Redis 3 commands except QUIT, MONITOR, SLOWLOG and SYNC.
- [Pub/Sub](https://godoc.org/github.com/arcoraven/redis#PubSub).
- [Transactions](https://godoc.org/github.com/arcoraven/redis#Multi).
- [Pipeline](https://godoc.org/github.com/arcoraven/redis#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/arcoraven/redis#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/arcoraven/redis#Script).
- [Timeouts](https://godoc.org/github.com/arcoraven/redis#Options).
- [Redis Sentinel](https://godoc.org/github.com/arcoraven/redis#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/arcoraven/redis#NewClusterClient).
- [Ring](https://godoc.org/github.com/arcoraven/redis#NewRing).
- [Instrumentation](https://godoc.org/github.com/arcoraven/redis#ex-package--Instrumentation).
- [Cache friendly](https://github.com/go-redis/cache).
- [Rate limiting](https://github.com/go-redis/rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/arcoraven/redis.
Examples: https://godoc.org/github.com/arcoraven/redis#pkg-examples.
...
```shell
go get -u github.com/arcoraven/redis
```

Import:

```go
import "github.com/arcoraven/redis"
```
...
Please go through [examples](https://godoc.org/github.com/arcoraven/redis#pkg-examples) to get an idea how to use this package.
